...
int main(int argc, char** argv) {
    if (argc < 10) {
        std::cout << "usage: ./alsh_mip U_factor V_factor topk output_path hash_r hash_K hash_L trans_m trans_u [if_normalize_query latent_factors U_size V_size]" << std::endl;
        return 0;
    }
    int d = 150;
    int U_size = 1000;
